...
public class Formkamar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jk.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "400k", "500k", "600k", "700k", "800k", "900k", "1.000k", "1.2jt", "1.4jt" }));
        ...
        kamar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Studio room", "Couple bed", "Family room", "King Size", "Suite Class", "Penthouse" }));
    ...
    private void tablesiswaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablesiswaMouseClicked
        ...
        kamar.setSelectedItem(tablesiswa.getValueAt(tablesiswa.getSelectedRow(),2).toString());
...
public void judul(){
    Object[] judul={
        "NIK","Nama","Tipe Kamar","Harga","Deskripsi"};
